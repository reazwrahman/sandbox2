...
def selectBatters():   
    ...
    if formForBatters.validate_on_submit(): 
        ...
        if len(batterSelections)<4 or len(batterSelections)>7:  
            ...
            return render_template('squadSelection/playerSelectionPage.html',instruction=instruction_header,form=formForBatters)   
        else:        
...
def selectBowlers():   
    ...
    if formForBowlers.validate_on_submit(): 
        ...
        if len(bowlerSelections)<4 or len(bowlerSelections)>7:  
            ...
            return render_template('squadSelection/playerSelectionPage.html',instruction=instruction_header,form=formForBowlers)   
...
def selectCapAndVc():  
    ...
    return render_template('squadSelection/captainAndVcSelectionPage.html',form=form)
...
def finalizeSquad(): 
    ...
    return render_template('squadSelection/SquadSelectionResult.html',selections=full_squad,Cap_Vc_Dict=Cap_Vc_Dict,form=form)   
...
def editSquad():  
    ...
    return render_template('squadSelection/EditSquadPage.html',selections=full_squad,form=form)  
